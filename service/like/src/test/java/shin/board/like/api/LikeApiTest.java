...
public class LikeApiTest {
    ...
    void likePerformanceTest() throws InterruptedException {
        ...
        likePerformanceTest(executorService, 9999L, "pessimistic-lock-1");
        likePerformanceTest(executorService, 8888L, "pessimistic-lock-2");
        likePerformanceTest(executorService, 7777L, "optimistic-lock");
    }
